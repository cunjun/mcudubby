...
class KeilBuildRuntime:
    ...
    def build(
        ...
        log_path = self._resolve_log_path(build.build_log_path, project_path, "McuBuddy_build.log")
    ...
    def flash(
        ...
        project_path = self._require_path(build.project_path, "build.project_path")
        target_name = self._require_value(build.target_name, "build.target_name")
        log_path = self._resolve_log_path(build.flash_log_path, project_path, "McuBuddy_flash.log")
