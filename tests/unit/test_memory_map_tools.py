...
from mcudubby.elf_manager import ElfManager
from mcudubby.tools.probe import read_memory_map
...
def test_elf_manager_get_sections_includes_lma(monkeypatch, tmp_path: Path) -> None:
    monkeypatch.setattr("mcudubby.elf_manager.ELFFile", _FakeElfFile)
